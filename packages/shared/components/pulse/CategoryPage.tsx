...
const ALL_CATEGORIES = [
  { slug: "music",      label: "Music",       desc: "Artists, releases, and the sounds shaping culture." },
  ...
  { slug: "travel",     label: "Travel",      desc: "Destinations, journeys, and everywhere culture takes you." },
  ...
  { slug: "tech",       label: "Tech",        desc: "Innovation, startups, and technology shaping culture." },
];
