        ...
        <span className="mem-stat-label">
          ...
          {openTooltip === 'credits' && (
            <div className="mem-tooltip" role="tooltip">
              <strong>Moveee Credits</strong> are your spendable currency. Earn them by posting, engaging, and participating in the community. Redeem them for partner perks or cash out (Connect Pro only). Daily cap: <strong>50 credits</strong>.
            </div>
          )}
        </span>
        {capHit ? (
