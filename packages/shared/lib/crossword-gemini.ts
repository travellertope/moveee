...
export async function generateCrosswordWithGemini(): Promise<GeminiCrosswordResponse | null> {
  ...
  const prompt = `You are a crossword master specializing in culture.
...
5. All words and clues must relate to culture (people, places, food, music, history, traditions) — draw from a genuinely broad mix of regions, not any one part of the world.
