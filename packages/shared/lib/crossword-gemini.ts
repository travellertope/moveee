...
export async function generateCrosswordWithGemini(): Promise<GeminiCrosswordResponse | null> {
  ...
  const prompt = `You are a crossword master specializing in African, Caribbean, and Black diaspora culture.
...
5. All words and clues must relate to African, Caribbean, and Black diaspora culture (people, places, food, music, history, traditions) — other regions are welcome but should not dominate.
