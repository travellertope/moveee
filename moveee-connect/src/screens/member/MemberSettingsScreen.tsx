...
const INTEREST_OPTIONS = [
  "Music", "Film", "Art", "Fashion", "Literature", "Food",
  "Tech", "Sport", "Travel", "Design", "Ideas", "History",
  "Science", "Business", "Health", "Spirituality",
];
      ...
      <View style={styles.chipsWrap}>
        {INTEREST_OPTIONS.map((i) => (
          <TouchableOpacity
            ...
            onPress={() => toggle(i)}
          >
            <Text style={[styles.chipText, selected.includes(i) && styles.chipTextActive]}>{i}</Text>
          </TouchableOpacity>
        ))}
      </View>
      <TouchableOpacity style={styles.saveBtn} onPress={save} disabled={saving}>
