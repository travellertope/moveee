            ...
            acf_add_local_field_group( array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'        => 'url',
                        'instructions'=> 'Full profile link, e.g. https://instagram.com/yourhandle',
                        'wrapper'     => array( 'width' => '25' ),
                    ),
                    array(
                        'key'         => 'field_connect_dir_twitter',
                        'label'       => 'X / Twitter URL',
                        'name'        => '_culture_directory_twitter',
                        'type'        => 'url',
                        'instructions'=> 'Full profile link, e.g. https://x.com/yourhandle',
                        'wrapper'     => array( 'width' => '25' ),
                    ),
                    array(
