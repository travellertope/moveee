...
class Culture_REST_API {
    ...
    public static function register_routes() {
        ...
        register_rest_route( 'culture/v1', '/cluster/discover', array(
            'methods'             => 'GET',
            'callback'            => array( __CLASS__, 'handle_cluster_discover' ),
            'permission_callback' => array( __CLASS__, 'api_key_permission' ),
        ) );

        register_rest_route( 'culture/v1', '/cluster/my-clusters', array(
            'methods'             => 'GET',
        ...
        register_rest_route( 'culture/v1', '/cluster/(?P<id>\d+)', array(
            'methods'             => 'GET',
            'callback'            => array( __CLASS__, 'handle_cluster_get' ),
            'permission_callback' => array( __CLASS__, 'api_key_permission' ),
        ) );

        register_rest_route( 'culture/v1', '/cluster/(?P<id>\d+)/status', array(
            'methods'             => 'GET',
        ...
        register_rest_route( 'culture/v1', '/cluster/(?P<id>\d+)/join', array(
            'methods'             => 'POST',
        ...
        register_rest_route( 'culture/v1', '/cluster/(?P<id>\d+)/leave', array(
            'methods'             => 'POST',
