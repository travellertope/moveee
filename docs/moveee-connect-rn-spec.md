...
- **Quick links**: Collection, Settings, Newsletters, Events, Magazine, Directory, Quotes, Sign out

---

## 14. MemberSettingsScreen

**Source reference:** `app/member/settings/page.tsx`

Tabbed/scrollable settings with these sections:
...
### Phase 6 — Member Hub
21. `MemberDashboardScreen` (Section 13)
22. `MemberSettingsScreen` (Section 14)
