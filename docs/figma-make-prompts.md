...
>
> **This file is mobile-only** (`apps/mobile`, iOS & Android, 390×844px frames throughout).
> For webapp screens (`apps/site` / `apps/connect`, desktop 1440px + mobile-companion frames),
> see `docs/figma-make-prompts-web.md` instead — that file used to live here as §18–19 and was
> split out (June 2026) since the webapp catalog has its own growing set of screens.
