...
const toggleStyles = StyleSheet.create({
  track: {
    ...
    backgroundColor: colors.ghost, justifyContent: "center", padding: 2,
  },
  trackOn: { backgroundColor: colors.ochre },
  knob: {
    width: 20, height: 20, borderRadius: 10, backgroundColor: colors.paper,
...
function StickyButton({ label, onPress, loading }: { label: string; onPress: () => void; loading: boolean }) {
  return (
    <View style={stickyStyles.container}>
      <TouchableOpacity style={stickyStyles.btn} onPress={onPress} disabled={loading} activeOpacity={0.85}>
        {loading
...
const stickyStyles = StyleSheet.create({
  container: {
    ...
    backgroundColor: colors.paper, paddingHorizontal: 16,
    paddingBottom: 34, paddingTop: 16,
    borderTopWidth: 1, borderTopColor: colors.rule + "30",
  },
  btn: {
    height: 52, borderRadius: radius.full, backgroundColor: colors.ochre,
    alignItems: "center", justifyContent: "center",
  },
  btnText: { fontFamily: fonts.sansBold, fontSize: fontSize.base, color: colors.paper },
});
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 120 }}>
        ...
        <View style={pf.wrap}>
          ...
          <View style={{ position: "relative" }}>
            ...
            />
            <Ionicons
              name="lock-closed-outline" size={16} color={colors.ghost}
        ...
        <View style={pf.wrap}>
          ...
          <TouchableOpacity style={pf.selectRow} activeOpacity={0.7}>
            ...
            <Ionicons name="chevron-down" size={16} color={colors.ghost} />
          </TouchableOpacity>
        </View>
...
const profileStyles = StyleSheet.create({
  ...
  avatarInitials:    { fontFamily: fonts.serifBold, fontSize: fontSize.xl, color: colors.gold },
  cameraBtn: {
    position: "absolute", bottom: 0, right: 0,
    width: 28, height: 28, borderRadius: 14,
    backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.ghost + "4D",
    justifyContent: "center", alignItems: "center",
    shadowColor: "#000", shadowOpacity: 0.12, shadowRadius: 4, elevation: 2,
  },
  editPhotoText: { fontFamily: fonts.sans, fontSize: 12, color: colors.ochre },
  ...
  genderText:       { fontFamily: fonts.sans, fontSize: fontSize.sm, color: colors.inkSoft },
  genderTextActive: { color: colors.paper },
});

const pf = StyleSheet.create({
  wrap:  { marginBottom: 14 },
  label: { fontFamily: fonts.sans, fontSize: 11, color: colors.mute, marginBottom: 6 },
  input: {
    height: 52, borderWidth: 1, borderColor: colors.ghost,
    borderRadius: 6, paddingHorizontal: 16,
    fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink,
    backgroundColor: colors.paper,
  },
  inputLocked: { backgroundColor: colors.paperDeep, color: colors.ghost, paddingRight: 40 },
  prefixRow: {
  ...
  prefixBox: {
    backgroundColor: colors.paperDeep, paddingHorizontal: 12,
    justifyContent: "center", alignItems: "center",
    borderRightWidth: 1, borderRightColor: colors.ghost,
  },
  prefixText:        { fontFamily: fonts.sans, fontSize: fontSize.sm, color: colors.mute },
  prefixInput: {
    flex: 1, paddingHorizontal: 12,
    fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink,
  },
  selectRow: {
    height: 52, borderWidth: 1, borderColor: colors.ghost, borderRadius: 6,
    paddingHorizontal: 16, flexDirection: "row", alignItems: "center",
    backgroundColor: colors.paper, justifyContent: "space-between",
  },
...
const dirStyles = StyleSheet.create({
  toggleRow: {
    ...
    height: 80, borderBottomWidth: 1, borderBottomColor: colors.ghost,
    marginBottom: 20,
  },
  toggleLabel: { fontFamily: fonts.sansBold, fontSize: fontSize.base, color: colors.ink },
  toggleSub:   { fontFamily: fonts.sans, fontSize: 12, color: colors.mute, marginTop: 2 },

  bioInput: {
    borderWidth: 1, borderColor: colors.ghost, borderRadius: 6,
    paddingHorizontal: 16, paddingTop: 14, paddingBottom: 14,
    minHeight: 140, fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink,
    backgroundColor: colors.paper,
  },
  charCount: {
  ...
  pillText:       { fontFamily: fonts.sans, fontSize: fontSize.sm, color: colors.inkSoft },
  pillTextActive: { color: colors.paper },

  socialHeader: { fontFamily: fonts.sansBold, fontSize: 14, color: colors.ink, marginBottom: 12 },
  socialRow: {
    flexDirection: "row", height: 52,
    borderWidth: 1, borderColor: colors.ghost, borderRadius: 6,
  ...
  socialPrefixText: { fontFamily: fonts.sans, fontSize: fontSize.sm, color: colors.mute },
  socialInput: {
    flex: 1, paddingHorizontal: 12,
    fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink,
  },
            ...
            {row.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {active ? (
                    <Ionicons name="checkmark" size={20} color={colors.ochre} />
                  ) : (
...
const intStyles = StyleSheet.create({
  heading:         { fontFamily: fonts.serifBold, fontSize: fontSize.lg, color: colors.ink, marginBottom: 6 },
  sub:             { fontFamily: fonts.sans, fontSize: 14, color: colors.mute, marginBottom: 20 },
  row:             { flexDirection: "row", gap: 10, marginBottom: 10 },
  card: {
    flex: 1, height: 72, borderRadius: 12,
    backgroundColor: colors.paper, flexDirection: "row", alignItems: "center",
  ...
  cardLabel:       { fontFamily: fonts.sansBold, fontSize: 14, color: colors.ink, flex: 1 },
  emptyCircle: {
...
function NewslettersTab() {
  ...
  if (loading) return <ActivityIndicator style={{ marginTop: 40 }} color={colors.ochre} />;
...
const nlStyles = StyleSheet.create({
  ...
  badge: {
    fontFamily: fonts.sansBold, fontSize: 9, color: colors.success,
    backgroundColor: colors.success + "1A", borderRadius: radius.full,
    paddingHorizontal: 8, paddingVertical: 3, overflow: "hidden",
    letterSpacing: 0.5,
  },
  nlName:     { fontFamily: fonts.sansBold, fontSize: 16, color: colors.ink, marginBottom: 4 },
  nlDesc:     { fontFamily: fonts.sans, fontSize: fontSize.sm, color: colors.inkSoft, marginBottom: 12 },
  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
      ...
      <View style={[secStyles.card, shadows.card]}>
        ...
        {loading ? (
          <ActivityIndicator color={colors.ochre} style={{ marginVertical: 16 }} />
        ) : passkeys.length === 0 ? (
          <View style={secStyles.emptyPasskeys}>
            <Ionicons name="finger-print-outline" size={32} color={colors.ghost} />
          ...
          <View style={secStyles.passkeyList}>
            {passkeys.map((pk, i) => (
              ...
              >
                <Ionicons name="finger-print-outline" size={24} color={colors.ochre} />
                <View style={{ flex: 1 }}>
                ...
                >
                  <Ionicons
                    ...
                    color={trashHover === pk.credential_id ? colors.error : colors.ghost}
                  />
                </TouchableOpacity>
              </View>
            ))}
        ...
        >
          {adding ? (
            ...
            <>
              <Ionicons name="finger-print-outline" size={18} color={colors.ink} />
...
const secStyles = StyleSheet.create({
  heading:  { fontFamily: fonts.serifBold, fontSize: fontSize.lg, color: colors.ink, marginBottom: 20 },
  card:     { backgroundColor: colors.paper, borderRadius: 12, overflow: "hidden", marginBottom: 4 },

  passwordRow: {
    height: 52, flexDirection: "row", alignItems: "center", gap: 12,
    paddingHorizontal: 16,
  },
  passwordLabel: { fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink, flex: 1 },
  passwordSub:   {
  ...
  passkeyTitle:   { fontFamily: fonts.sansBold, fontSize: fontSize.base, color: colors.ink },
  passkeySub:     { fontFamily: fonts.sans, fontSize: 12, color: colors.mute, marginTop: 2 },
  ...
  emptyPasskeysText: { fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.mute },

  passkeyList:      { borderTopWidth: 1, borderTopColor: colors.ghost + "4D" },
  passkeyRow: {
    flexDirection: "row", alignItems: "center", gap: 12,
    paddingHorizontal: 16, paddingVertical: 14,
  },
  passkeyRowBorder: { borderTopWidth: 1, borderTopColor: colors.ghost + "4D" },
  pkDevice: { fontFamily: fonts.sansBold, fontSize: 14, color: colors.ink },
  pkDate:   { fontFamily: fonts.mono, fontSize: 11, color: colors.mute, marginTop: 2 },

  addPasskeyBtn: {
    margin: 16, height: 44, borderWidth: 1, borderColor: colors.ink, borderRadius: 8,
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
  },
  addPasskeyText: { fontFamily: fonts.sans, fontSize: fontSize.base, color: colors.ink },
});
...
const mainStyles = StyleSheet.create({
  ...
  tabStrip:        { flexGrow: 0, height: 44, borderBottomWidth: 1, borderBottomColor: colors.rule },
  ...
  tabUnderline: {
    position: "absolute", bottom: 0, left: 0, right: 0,
    height: 2, backgroundColor: colors.ochre,
  },
});
