...
export const BADGE_META: Record<string, { name: string; emoji: string; description: string }> = {
  ...
  profile_complete:                             { name: "Profile Complete",       emoji: "🪪", description: "Completed your Moveee Connect profile." },
  directory_member:                              { name: "In the Directory",       emoji: "📇", description: "Opted into the Moveee Connect member directory." },
  newsletter_subscriber:                          { name: "Newsletter Subscriber",  emoji: "📬", description: "Subscribed to a Moveee newsletter." },
  monthly_member:                                  { name: "Monthly Member",         emoji: "📅", description: "Been a Moveee Connect member for 30 days." },
  veteran:                                          { name: "Veteran",                emoji: "🛡️", description: "Been a Moveee Connect member for 180 days." },
  annual_advocate:                                   { name: "Annual Advocate",        emoji: "⭐", description: "Been a Moveee Connect member for a full year." },
