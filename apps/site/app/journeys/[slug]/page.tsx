...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  try {
    const data = await getWPData(GET_JOURNEY_BY_SLUG, { slug }, { revalidate: 3600 });
    ...
    <div className="journey-page bg-paper">
      ...
      <section className="journey-hero">
        ...
        <div className="journey-hero-content">
          ...
          <p className="journey-hero-sub">{journey.excerpt?.replace(/<[^>]*>/g, "") || "A culturally anchored journey."}</p>
