...
/**
 * apps/site's own copy of apps/connect's route of the same name — needed
 * here for the post-checkout Moveee Lit "complete your profile" page
 * (app/literary/lit-welcome/page.tsx), which lives on Site A. Kept in sync
 * with that file — same WordPress endpoint, same auth model, same
