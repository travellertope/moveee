          ...
          <div className="visual-single-info">
            ...
            <div className="visual-single-desc">
              {entry.excerpt ? (
                ...
                <p>A curated AI-generated illustration representing culture. This artwork is part of the Moveee Visuals archive.</p>
              )}
            </div>
      ...
      {isModalOpen && (
        <div className="visual-modal-backdrop" onClick={() => setIsModalOpen(false)}>
          <div className="visual-modal" onClick={e => e.stopPropagation()}>
            ...
            <p>
              You've hit your daily limit of 5 downloads. To enjoy unlimited downloads and support independent culture, upgrade to Moveee Pro.
            </p>
