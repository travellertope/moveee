  ...
  const createRes = await fetch(`${BASE}/community-posts`, {
    ...
    body: JSON.stringify({
      ...
      meta: {
        ...
        _linked_directory_id:   linked_directory_id ? String(linked_directory_id) : "",
        _star_rating:           star_rating ? String(star_rating) : "",
        _location_name:         location_name?.trim() || "",
        _location_lat:          location_lat ? String(location_lat) : "",
        _location_lng:          location_lng ? String(location_lng) : "",
        ...
        _food_rating_taste:     food_rating_taste ? String(food_rating_taste) : "",
        _food_rating_value:     food_rating_value ? String(food_rating_value) : "",
        _food_rating_vibe:      food_rating_vibe ? String(food_rating_vibe) : "",
      },
    }),
    cache: "no-store",
  });
